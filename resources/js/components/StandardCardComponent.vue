    ...
    <div class="wrapper col-3">
        <div class="card card--rounded wrapper__front">
            <div class="card__header">
                <img
                    :src="item.poster_path ? `https://image.tmdb.org/t/p/w220_and_h330_face/${item.poster_path}` : (item.profile_path ? `https://image.tmdb.org/t/p/w220_and_h330_face/${item.profile_path}` : 'https://via.placeholder.com/220x330?text=Not+Available') "
                    alt="poster"
                    class="card__image"/>
            </div>
        </div>
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <button class="btn btn--transparent btn--circle">
                            <svg class="card__icon" fill="none" height="24" viewBox="0 0 24 24"
                        ...
                        <button class="btn btn--transparent btn--circle">
                            <svg class="card__icon" fill="currentColor" height="24" viewBox="0 0 24 24"
                                 width="24" xmlns="http://www.w3.org/2000/svg">
                                <path
